...
| Contact              | <mailto:help@annaisystems.com>                                                                    |
...
These systems use the [Overture Score](https://github.com/overture-stack/score) software to provide access to data sets.

| Property         | Value                                                                                          |
| :--------------- | ---------------------------------------------------------------------------------------------- |
| Name             | Overture Score Repositories                                                                    |
| Governing Body   | Otario Institute for Cancer Research                                                           |
| Contact          | <mailto:dcc-support@icgc.org>                                                                  |
| Official Website | <https://dcc.icgc.org>                                                                         |
| Download Client  | [Tarball](/software/binaries/#score-client) [Docker](https://hub.docker.com/r/overture/score/) |

...
\* Two pcawg seperate repoisitories are hosted in Chicago, each for a different research project.
...
```shell
aws s3 --endpoint-url=https://https://bionimbus-objstore-cs.opensciencedatacloud.org/ cp $DATA_PATH $OUTPUT_DIR
```

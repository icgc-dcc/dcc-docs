    ...
    <div id="content-inner" class="content-inner block">
     <div id="content-inner-inner" class="content-inner-inner inner">
      <div id="content-content" class="content-content">
       <div id="node-6999" class="node odd full-node node-type-book">
        <div class="inner">
         <div class="content clearfix">
            ...
            <table class="table table-condensed table-hover sortable">
             ...
             <tbody>
              ...
              <tr class="pbi-avoid">
               ...
               <td class="cv-value">
                Partner breakpoint found, and paired sequence either side of breakpoint
               </td>
              </tr>
             </tbody>
            </table>
          ...
          <div id="book-navigation-6310" class="book-navigation">
           <div class="page-links clear-block">
            <a href="/sequencing-based-mirna-expression-mirnaseq-primary-file-p" class="page-previous" title="Go to previous page">
             ‹ Sequencing-based miRNA Expression (mirna_seq) - Primary File (p)
            </a>
            <a href="/dictionary" class="page-up" title="Go to parent page">
             up
            </a>
            <a href="/protein-expression-pexp-analysis-metadata-file-m" class="page-next" title="Go to next page">

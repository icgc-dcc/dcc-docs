    ...
    <div id="content-inner" class="content-inner block">
     <div id="content-inner-inner" class="content-inner-inner inner">
      <div id="content-content" class="content-content">
       <div id="node-6552" class="node odd full-node node-type-book">
        <div class="inner">
         <div class="content clearfix">
           ...
           <table class="table table-condensed table-hover sortable">
            ...
            <tbody>
             ...
             <tr class="identifier-element success pbi-avoid">
              ...
              <td class="element-description">
               <small>
                Unique identifier(s) for the matched sample(s) used in the analysis; must exist in the sample file. Cannot contain whitespace, semi-colons or special characters. Can contain alphanumeric characters, dashes or underscores.
               </small>
              </td>
              <td class="datatype text">
               TEXT
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes inplace">
               <div class="link">
                <small>
                 [
                 <a href="https://docs.icgc.org/controlled-vocabulary-09a#GLOBAL.0.assembly_version.v2">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes appendix">
               <div class="link">
                <small>
                 [
                 <a href="https://docs.icgc.org/controlled-vocabulary-09a#GLOBAL.0.sequencing_strategy.v1">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes inplace">
               <div class="link">
                <small>
                 [
                 <a href="https://docs.icgc.org/controlled-vocabulary-09a#GLOBAL.0.raw_data_repository.v2">
          ...
          <div id="book-navigation-6310" class="book-navigation">
           <div class="page-links clear-block">
            <a href="/donor-therapy-therapy-09a" class="page-previous" title="Go to previous page">
             ‹ Donor Therapy (therapy) - 0.9a
            </a>
            <a href="/dictionary-v09a-june-2014-release-17" class="page-up" title="Go to parent page">
             up
            </a>
            <a href="/simple-somatic-mutations-ssm-primary-analysis-file-p-09a" class="page-next" title="Go to next page">

    ...
    <div id="content-inner" class="content-inner block">
     <div id="content-inner-inner" class="content-inner-inner inner">
      <div id="content-content" class="content-content">
       <div id="node-6442" class="node odd full-node node-type-book">
        <div class="inner">
         <div class="content clearfix">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes appendix">
               <div class="link">
                <small>
                 [
                 <a href="https://docs.icgc.org/controlled-vocabulary/#specimen.0.specimen_type.v1">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes inplace">
               <div class="link">
                <small>
                 [
                 <a href="https://docs.icgc.org/controlled-vocabulary/#specimen.0.specimen_donor_treatment_type.v1">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes inplace">
               <div class="link">
                <small>
                 [
                 <a href="https://docs.icgc.org/controlled-vocabulary/#specimen.0.specimen_processing.v1">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes inplace">
               <div class="link">
                <small>
                 [
                 <a href="https://docs.icgc.org/controlled-vocabulary/#specimen.0.specimen_storage.v1">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="element-description">
               <small>
                ...
                <a href="https://w2.iarc.fr/en/publications/pdfs-online/pat-gen/bb2/BB2.pdf">
          ...
          <div id="book-navigation-6310" class="book-navigation">
           <div class="page-links clear-block">
            <a href="/donor-data-file-donor-08d" class="page-previous" title="Go to previous page">
             ‹ Donor Data File (donor)
            </a>
            <a href="/dictionary-v08d-mar-2014-release-16" class="page-up" title="Go to parent page">
             up
            </a>
            <a href="/analyzed-sample-data-file-sample-08d" class="page-next" title="Go to next page">

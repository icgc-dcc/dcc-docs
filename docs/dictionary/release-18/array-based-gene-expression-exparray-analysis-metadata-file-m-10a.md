<h1 class="title">
 Array-based Gene Expression (exp_array) - Analysis Metadata File (m) -v0.10a
</h1>
    ...
    <div id="content-inner" class="content-inner block">
     <div id="content-inner-inner" class="content-inner-inner inner">
      <div id="content-content" class="content-content">
       <div id="node-6712" class="node odd full-node node-type-book">
        <div class="inner">
         <div class="content clearfix">
          <div class="file-spec">
           <h2>
            File Type: &#39;Array-based Gene Expression (exp_array) - Analysis Metadata File (m)&#39;
           </h2>
           <h3>
            File Key: &#39;exp_array_m&#39;
           </h3>
           <h3>
            File Name
          ...
          <div id="book-navigation-6310" class="book-navigation">
           <div class="page-links clear-block">
            <a href="/structural-somatic-mutations-stsm-secondary-analysis-file-s-10a" class="page-previous" title="Go to previous page">
             ‹ Structural Somatic Mutations (stsm) - Secondary Analysis File (s) -v0.10a
            </a>
            <a href="/dictionary-v10a-october-2014" class="page-up" title="Go to parent page">
             up
            </a>
            <a href="/array-based-gene-expression-exparray-primary-file-p-10a" class="page-next" title="Go to next page">
             Array-based Gene Expression (exp_array) - Primary File (p) -v0.10a ›
            </a>
           </div>
          </div>
         </div>

<h1 class="title">
 Copy Number Somatic Mutations (cnsm) - Analysis Metadata File (m) -v0.10a
</h1>
    ...
    <div id="content-inner" class="content-inner block">
     <div id="content-inner-inner" class="content-inner-inner inner">
      <div id="content-content" class="content-content">
       <div id="node-6708" class="node odd full-node node-type-book">
        <div class="inner">
         <div class="content clearfix">
          <div class="file-spec">
           <h2>
            File Type: &#39;Copy Number Somatic Mutations (cnsm) - Analysis Metadata File (m)&#39;
           </h2>
           <h3>
            File Key: &#39;cnsm_m&#39;
           </h3>
           ...
           <table class="table table-condensed table-hover sortable">
            ...
            <tbody>
             ...
             <tr class="identifier-element success pbi-avoid">
              ...
              <td class="element-description">
               <small>
                A unique identifier representing the particular non-normal sample that was analyzed; analyzed sample identifiers must be used consistently to relate those described in the sample file and in the related analysis files
               </small>
              </td>
              <td class="datatype text">
               TEXT
             ...
             <tr class="identifier-element success pbi-avoid">
              ...
              <td class="element-description">
               <small>
                Unique identifier for the matched normal sample used in the analysis; must exist in the sample file
               </small>
              </td>
              <td class="datatype text">
               TEXT
               ...
               <small>
                <ul>
                 <li style="font-size:10px">
                  The sample identifiers used for matched_sample_id and analyzed_sample_id cannot be identical
                 </li>
                </ul>
                <p>
                </p>
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes inplace">
               <div class="link">
                <small>
                 [
                 <a href="#GLOBAL.0.assembly_version.v2">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="element-description">
               <small>
                Name of base calling algorithm and option to include URL to written protocol and/or algorithm parameters. Syntax should be: &#39;&lt;Name of Protocol&gt;&lt;single whitespace&gt;&lt;URL to protocol (optional)&gt;&lt;single whitespace&gt;&lt;algorithm parameters (optional)&gt;&#39;
               </small>
              </td>
              <td class="datatype text">
               TEXT
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="element-display-name">
               Variation Calling Algorithm
              </td>
              <td class="element-description">
               <small>
                Name of variation calling algorithm and option to include URL to written protocol and/or algorithm parameters. Syntax should be: &#39;&lt;Name of Protocol&gt;&lt;single whitespace&gt;&lt;URL to protocol (optional)&gt;&lt;single whitespace&gt;&lt;algorithm parameters (optional)&gt;&#39;
               </small>
              </td>
              <td class="datatype text">
               TEXT
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="element-description">
               <small>
                Sequencing technique intended for the analyzed sample library. Use of N/A reserved for when a non-sequencing strategy is used (example: comparative hybridization array)
               </small>
              </td>
              <td class="datatype cv">
               CV
              ...
              <td class="codes appendix">
               <div class="link">
                <small>
                 [
                 <a href="#GLOBAL.0.sequencing_strategy.v1">
             ...
             <tr class="optional-element pbi-avoid">
              ...
              <td class="element-description">
               <small>
                Sequence coverage if analyzed by sequencing platforms
               </small>
              </td>
          ...
          <div id="book-navigation-6310" class="book-navigation">
           <div class="page-links clear-block">
            <a href="/simple-germline-variation-sgv-primary-analysis-file-p-10a" class="page-previous" title="Go to previous page">
             ‹ Simple Germline Variation (sgv) - Primary Analysis File (p) -v0.10a
            </a>
            <a href="/dictionary-v10a-october-2014" class="page-up" title="Go to parent page">
             up
            </a>
            <a href="/copy-number-somatic-mutations-cnsm-primary-analysis-file-p-10a" class="page-next" title="Go to next page">
             Copy Number Somatic Mutations (cnsm) - Primary Analysis File (p) -v0.10a ›
            </a>
           </div>
          </div>
         </div>

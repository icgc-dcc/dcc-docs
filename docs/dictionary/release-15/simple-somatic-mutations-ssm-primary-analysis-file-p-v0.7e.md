    ...
    <div id="content-inner" class="content-inner block">
     <div id="content-inner-inner" class="content-inner-inner inner">
      <div id="content-content" class="content-content">
       <div id="node-6296" class="node odd full-node node-type-book">
        <div class="inner">
         <div class="content clearfix">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes appendix">
               <div class="link">
                <small>
                 [
                 <a href="/controlled-vocabulary-v0.7e/#GLOBAL.0.chromosome.v3">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="element-description">
               <small>
                <ul>
                 <li style="font-size:10px">
                  When specified, up to four alleles can be specified, each separated by a comma (no whitespace allowed)
                  <br>
                 </li>
                 <li style="font-size:10px">
                  Each allele must consist of one or more of A, C, T, G or a dash, and must be one of the alleles in tumour_genotype
                 </li>
                </ul>
                <p>
                </p>
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes inplace">
               <div class="link">
                <small>
                 [
                 <a href="/controlled-vocabulary-v0.7e/#GLOBAL.0.verification_status.v2">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes inplace">
               <div class="link">
                <small>
                 [
                 <a href="/controlled-vocabulary-v0.7e/#GLOBAL.0.biological_validation_status.v3">
             ...
             <tr class="required-element info pbi-avoid">
              ...
              <td class="codes appendix">
               <div class="link">
                <small>
                 [
                 <a href="/controlled-vocabulary-v0.7e/#GLOBAL.0.platform.v1">
                  GLOBAL.0.platform.v1
                 </a>
                 ]
                </small>
          ...
          <div id="book-navigation-6310" class="book-navigation">
           <div class="page-links clear-block">
            <a href="/simple-somatic-mutations-ssm-analysis-metadata-file-m-v0.7e" class="page-previous" title="Go to previous page">
            ...
            <a href="/icgc-simple-somatic-mutation-format-v0.7e" class="page-next" title="Go to next page">
